...
function AddContent(props) {
  ...
  const handleSubmit = (event) => {
    ...
    // Add your logic to handle the form submission (e.g., dispatching memory content).
  }

  return (
    <div className="container">
      <h3>Remember these are public. Please don't tell on yourself or your friends.</h3>
      <h3>Add an image:</h3>
      <form onSubmit={handleSubmit}>
        ...
        {imagePath === '' ? (
          ...
          <img style={{ maxWidth: '150px' }} src={imagePath} alt="Selected" />
        )}
        <br /> <br />
